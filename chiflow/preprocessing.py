...
from utils.parse_xyz import parse_xyz_corpus_ase
...
def add_rxn_datapoint(args, feat_dict: dict, data_list: list, idx: int, a_smarts: str, rxn_block=None,
                      energies=None):
    r, p = a_smarts.split(">>")
    data, feat_dict = generate_ts_data2(r, p,
                                      ...
                                      add_chiral_edges=args.add_chiral_edges,
                                      )
...
if __name__ == "__main__":
    ...
    parser.add_argument("--add_chiral_edges", action="store_true", default=False)
