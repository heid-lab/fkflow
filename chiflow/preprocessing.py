...
def data_processing_main(args):
    ...
    if args.custom_mode == 1:
        ...
        train_index, valid_index, test_index = index_split(int(len(data_list) / 2), train=args.train, valid=args.valid,
                                                           seed=args.seed)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--rxn_raw_data_path", type=str,
                        default="data/TS/wb97xd3/raw_data/wb97xd3_fwd_rev_chemprop.csv")
